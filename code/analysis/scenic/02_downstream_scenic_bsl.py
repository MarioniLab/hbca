...
figdir = '/nfs/research/marioni/areed/projects/hbca/scenic/2022-04-05/scvi_new/bsl/output/plots/'
...
plt.tight_layout()
os.makedirs('/nfs/research/marioni/areed/projects/hbca/scenic/2022-04-05/scvi_new/bsl/output/plots/regulons/', exist_ok=True)
...
#get ordered topreg
topreg = []
for i, c in enumerate(['BSL1', 'BSL2']):
    topreg.extend(list(rss_cellType.T[c].sort_values(ascending=False)[:10].index))
topreg.extend(['SOX5(+)', 'IRF4(+)']) #'TP63(+)', 'SNAI2(+)',
topreg = list(set(topreg))
