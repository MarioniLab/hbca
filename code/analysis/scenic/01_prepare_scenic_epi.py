...
output_dir = '/nfs/research/marioni/areed/projects/hbca/scenic/2022-04-05/scvi_new/epi/output'
...
celltypes_to_study = ['LP1', 'LP2', 'LP3', 'LP4', 'LP proliferating', 'Other epithelial (1)', 'Other epithelial (2)',
                      "HS1", "HS2", "HS3", "HS4", "BSL1", "BSL2"]
adata = adata[adata.obs.level2.isin(celltypes_to_study), :]

# save full loom
f_loom_path_scenic = output_dir + "/loom/loom_epi_all.loom"
...
# save subsetted version (n=10*9000 + #(LP proliferating, Other epithelial (1), Other epithelial (2)))
...
for celltype_select in celltypes_to_study:
    ...
    if celltype_select in ['LP1', 'LP2', 'LP3', 'LP4', "HS1", "HS2", "HS3", "HS4", "BSL1", "BSL2"]:
...
f_loom_path_scenic = output_dir + "/loom/loom_epi_sub1.loom"
