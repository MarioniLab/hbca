...
figdir = '/nfs/research/marioni/areed/projects/hbca/scenic/2022-04-05/scvi_new/hs/output/plots/'
...
plt.tight_layout()
os.makedirs('/nfs/research/marioni/areed/projects/hbca/scenic/2022-04-05/scvi_new/hs/output/plots/regulons/', exist_ok=True)
...
colors = sns.color_palette(["#EDABB9", "#EB5C79", "#A06A75", "#C00028"])
colors2 = sns.color_palette(['#f1ce63', '#4e79a7', '#a0cbe8', '#f28e2b', '#ff9d9a', '#ff9d9a', '#bab0ac'])
...
#get ordered topreg
topreg = []
for i, c in enumerate(['HS1', 'HS2', 'HS3', 'HS4']):
    topreg.extend(list(rss_cellType.T[c].sort_values(ascending=False)[:10].index))
topreg.extend(['FOXA1(+)'])
topreg = list(set(topreg))
